...
import os
from config import D0, KDEATH, DT, TMAX, T_DORMANT, XMIN, XMAX, YMIN, YMAX, M_LENGTH, G_LENGTH, KB_MAX, KB_MIN, CONVERSION_FACTOR_UM
...
def morphometrics_time_series_plot(morphometrics_data, times, OUTPUT_DIR='', metric='volume_fraction', title='Volume Fraction'): ### currently only plots volume fraction
...
def growth_plot(Xe0, Xe_final, title, Xb=None, conversion_factor_um=200, OUTPUT_DIR='osei'):
