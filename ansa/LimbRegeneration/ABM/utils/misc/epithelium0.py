...
n_points_main = 200       # Number of points for the final boundary (semicircle + verticals + extensions)
...
Xb0[:,0] -= 1.0 # shift left by 1.0 so amputation plane is at x=0
...
# --- SAVE AND PLOT ---
np.savetxt(f"epi{n_points_main}.csv", Xb_full, delimiter=",", comments='')
print(f'saved epi{n_points_main}.csv')
