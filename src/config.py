...
OUTPUT_DIR = f'{REPO_ROOT}/simulationOutput'
...
ORIENTED_DIVISION_ANGLE = None # Angle in radians for directed division (None for no directed division)
...
POKING_POINTS = np.array(range(97, 103))
